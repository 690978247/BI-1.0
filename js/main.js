    ...
    data.ControlList.forEach((item, index) => {
      ...
      if (item.ControlType === 'solidrectangle') { //矩形样式
        html += `<div class="commonModule" draggable="false" data-id="${index}"
            onmousedown="handleDown(event)" onclick="setClass(${index},null,null,event)" oncontextmenu="openRightMenu(event,${index})"
          ...
          opacity: ${Number(item.PropertyList.Opacity) / 100};">
            <div class="moduleShape" style="background-image:url(${item.PropertyList.BackImg});background-size:100% 100%;background-repeat: no-repeat;"></div>
          </div>
          `
        ...
        html += `<div class="commonModule" draggable="false" data-id="${index}"
          ...
          height: ${item.PropertyList.Height}px; z-index: ${item.PropertyList.ZIndex};transform: rotate(${item.PropertyList.Rotate}deg);" >
          <textarea disabled="disabled" class="moduleShape common-input" style="padding:0;background-color: ${item.PropertyList.BackColor};border-radius:${item.PropertyList.BorderRadius}px;border-style: ${item.PropertyList.Style};border-color: ${item.PropertyList.BorderColor};
          ...
          box-shadow: ${item.PropertyList.BoxShadow};color: ${item.PropertyList.Color};font-size: ${item.PropertyList.FontSize}px;font-family: ${item.PropertyList.FontFamily};position:absolute;top:0px;text-align:${item.PropertyList.TextAlign};left:0px" 
          value="${item.PropertyList.Text}" readonly="readonly" onmousedown="inputdown(this,event,${index})" onblur="handleblur(event, ${index}, 'Text','menutype')" >${item.PropertyList.Text}</textarea>
        ...
        html += `<div class="commonModule" draggable="false" data-id="${index}"
          ...
          <textarea disabled="disabled" class="moduleShape common-input" style="padding:0;background-color: ${item.PropertyList.BackColor};border-radius:${item.PropertyList.BorderRadius}px;
          ...
          font-family: ${item.PropertyList.FontFamily};position:absolute;top:0px;left:0px" value="${item.PropertyList.Text}" 
          onmousedown="inputdown(this,event,${index})" onblur="handleblur(event, ${index}, 'Text','menutype')" readonly="readonly">${item.PropertyList.Text}</textarea>
        ...
        html += `<div class="commonModule" draggable="false" data-id="${index}"
          ...
          background-color: ${item.PropertyList.BackColor};box-shadow: ${item.PropertyList.BoxShadow}; height: ${item.PropertyList.Height}px;z-index: ${item.PropertyList.ZIndex};
          opacity: ${Number(item.PropertyList.Opacity) / 100};transform: rotate(${item.PropertyList.Rotate}deg);">
          <div class="moduleShape" style="background-image:url(${item.PropertyList.BackImg};);background-size:100% 100%;background-repeat: no-repeat;border-radius: 50%;"></div>
          ...
          <div style="width: 100%;height:100%;display: flex">
            <div class="global-select" style="height: 100%; margin-right: 10px;" >
              <div class="global-input" onmousedown="toggleItem(event, ${index})" style="height:100%;position:relative">
                ...
                style="position:absolute;top:0;height:100%;left:0; text-align: ${item.PropertyList.TextAlign};box-shadow: ${item.PropertyList.BoxShadow};color: ${item.PropertyList.Color};border-width: ${item.PropertyList.BorderWidth}px;border-style: ${item.PropertyList.Style};border-color: ${item.PropertyList.BorderColor};border-radius: ${item.PropertyList.BorderRadius}px;text-align: ${item.PropertyList.TextAlign};font-weight: ${item.PropertyList.FontWeight};text-decoration: ${item.PropertyList.TextDecoration}; font-size: ${item.PropertyList.FontSize}px;font-family: ${item.PropertyList.FontFamily};" placeholder="请选择" ></input>
            ...
            <input class="search-input" style="box-shadow: ${item.PropertyList.BoxShadow}; text-align: ${item.PropertyList.TextAlign};height: 100%;color: ${item.PropertyList.Color};border-width: ${item.PropertyList.BorderWidth}px;border-style: ${item.PropertyList.Style};border-color: ${item.PropertyList.BorderColor};border-radius: ${item.PropertyList.BorderRadius}px;text-align: ${item.PropertyList.TextAlign};font-weight: ${item.PropertyList.FontWeight};text-decoration: ${item.PropertyList.TextDecoration}; font-size: ${item.PropertyList.FontSize}px;font-family: ${item.PropertyList.FontFamily};" placeholder="${item.PropertyList.Placeholder}"
        ...
        html += `<div  class="commonModule" draggable="false" data-id="${index}"
          onmousedown="handleDown(event)" onmouseup="handleMouseUp(event,${index})" onclick="setClass(${index},'${item.Name}','piechart')" oncontextmenu="openRightMenu(event,${index})"
          style="left: ${item.PropertyList.Left}px;top: ${item.PropertyList.Top}px; width: ${item.PropertyList.Width}px;transform: rotate(${item.PropertyList.Rotate}deg);
        ...
        html += `<div  class="commonModule" draggable="false" data-id="${index}"
          onmousedown="handleDown(event)" onmouseup="handleMouseUp(event,${index})" onclick="setClass(${index},'${item.Name}','dashboardchart')" oncontextmenu="openRightMenu(event,${index})"
          style="left: ${item.PropertyList.Left}px;top: ${item.PropertyList.Top}px; width: ${item.PropertyList.Width}px;height: ${item.PropertyList.Height}px;
        ...
        html += `<div  class="commonModule" draggable="false" data-id="${index}"
          onmousedown="handleDown(event)" onmouseup="handleMouseUp(event,${index})" onclick="setClass(${index},'${item.Name}','barchart')" oncontextmenu="openRightMenu(event,${index})"
        ...
        html += `<div  class="commonModule" draggable="false" data-id="${index}"
          onmousedown="handleDown(event)" onmouseup="handleMouseUp(event,${index})" onclick="setClass(${index},'${item.Name}','linechart')" oncontextmenu="openRightMenu(event,${index})"
          style="left: ${item.PropertyList.Left}px;top: ${item.PropertyList.Top}px; width: ${item.PropertyList.Width}px;height: ${item.PropertyList.Height}px;z-index: ${item.PropertyList.ZIndex};transform: rotate(${item.PropertyList.Rotate}deg);">
          <div id="${item.Name}"  style="width:100%;height:100%;"></div>
          </div>`
      }
...
function convertPointStyle(point, defaultStyle, index, directionKey = {
  ...
  let types = ['textsearch', 'datasearch', 'dropsearch', 'associatedatetimepicker']
  let hasT = /t/.test(point)
  let hasB = /b/.test(point)
  let hasL = /l/.test(point)
  let hasR = /r/.test(point)
...
function reusedown(e, id, node) {
  ...
  if (node && node.parentId /* && node.nodeType === 'assembly' */ ) {
    ...
    document.addEventListener('dragstart', function (e) {
      console.log("index", JSON.stringify(name))
