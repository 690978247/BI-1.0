(function () {
	...
	Colorpicker.prototype = {
		init(opt) {
			...
			this.historycolor = ["rgb(255,255, 255)","rgb(255,255, 255)","rgb(255,255, 255)","rgb(255,255, 255)","rgb(255,255, 255)","rgb(255,255, 255)","rgb(255,255, 255)","rgb(255,255, 255)","rgb(255,255, 255)","rgb(255,255, 255)","rgb(255,255, 255)","rgb(255,255, 255)","rgb(255,255, 255)","rgb(255,255, 255)","rgb(255,255, 255)","rgb(255,255, 255)"]
            this.password = '100%'
				  ...
				  <img  src="../colorimg/nocolor.png" alt="" style="width:100%;height:100%">
					...
					<div class="flexbox-fix" style="display: flex;height:70px">
						...
						<input  class='hex' style='border:none;position:absolute;color:#eeeeee;font-size:12px;width:80px;height:20px;background:#171717;left:90px;top:10px;box-sizing: content-box;padding:0' value='#000000'/>		
						 <img src = '../colorimg/xq.png' style="width:22px;height:22px;position:absolute;top:43px;left:10px;cursor:pointer"  class='xq'>
