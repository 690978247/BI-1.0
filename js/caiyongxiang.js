...
// </li>
  ...
  let html = ` 
    ...
    <ul class="ul" style="float:left;width:auto;clear:none;width:62%">
    <li class="line"></li>
  ...
  <li class="li" onmouseover="showTips(event,'下移一层')" id="onebottom" title="下移一层" onclick='onebottom()'>
    ...
    <ul style="float:right;padding-left:0px;width:auto;clear:none;max-width:35%"> 
...
Controls.Data.PieChartItemList = newobject(Controls.Data.PieChartItemList)
  ...
  document.onkeydown = function (e) {
   keyCode = e.keyCode;
    ...
    //backSpace
    if (e.keyCode == 8) {
      if ($("input").is(":focus") || $("textarea").is(":focus") ) {} else {
        deletediv()
      }
    }
